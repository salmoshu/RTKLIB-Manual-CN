...
定位解算文件仅仅是RTKNAVI或RTKPOST输出的文本文件。该文件通过CR/LF分隔为记录或行。每条记录包含多个字段。下表展示了定位解算文件的格式。
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                如果在RTKGET中未指定本地目录，则下载的文件将保存在该目录中。目录路径可以包含与URL地址相同的关键词。
            </td>  
            <td></td>  
        </tr>
    </tbody>
